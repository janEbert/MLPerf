...
class NumpyExternalSource(object):
    ...
    def finalize_prefetching(self):
        ...
        while not self.prefetch_queue.empty():
            ...
            data_filename, data, label_filename, label = task.result()
            self.file_cache[data_filename] = data
            self.file_cache[label_filename] = label
...
class CamDaliESDataloader(object):
